...
WHERE event_object_table = 'cid_task';
...
SELECT cid_task_id, status FROM cid_task WHERE dependency_cid_id = 1;
...
BEGIN
    ...
    -- ✅ If the current task is "overdue", update all dependent tasks
