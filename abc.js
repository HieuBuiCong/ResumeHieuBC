...
const chartCardStyle = { borderRadius: 3, boxShadow: 3, p: 2, backgroundColor: 'rgba(255, 255, 255, 0.8)', backdropFilter: 'blur(6px)' };

const titleStyle = { fontSize: '1.05rem', fontWeight: 600, color: '#333' };

const labelTextStyle = { fill: '#212121', fontSize: 12, fontWeight: 500 };

const DashboardPage = () => { const { isAuthenticated } = useContext(AuthContext);

return ( <MainLayout> <Box sx={{ padding: 4, marginTop: '50px' }}> <Typography variant="h5" gutterBottom fontWeight={700} color="primary.dark"> 🎯 Interrupter CID Overview ✅ </Typography>
