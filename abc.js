...
---------------
const sendEmail = await sendTaskApprovalNotification(task, decision, approver_reason);
if (!sendEmail) return res.status(404).json({ success: false, message: "Failed to send email" });
